...
enter_new_list_in_order = 'Введите список новых имен для всех пользователей в порядке их расположения ' \
                          '(каждое имя с новой строки и не более 59 символов)'
...
enter_queue_name = 'Введите имя для очереди.\n' \
                   ...
                   'Должно быть в одной строке, длиной не больше 60 знаков'
...
command_for_private_chat = 'Используйте комманду в приватном чате'
