...
class CommandHandler:
    ...
    # ids and command_handling of type str
    ...
    def __init__(self):
        ...
        self._id_command_dict = {}  # command commands using their index as key
    ...
    def init_commands_from_module(self, module):
        from queue_bot.commands import AbstractCommand
    ...
    def get_command_class(self, command_index):
