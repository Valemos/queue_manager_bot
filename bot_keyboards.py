...
keyboard_modify_queue = InlineKeyboardMarkup([
    ...
    [InlineKeyboardButton('Удалить студентов',              callback_data=ModifyQueue.RemoveStudent.str())],
...
keyboard_modify_registered = InlineKeyboardMarkup([
    ...
    [InlineKeyboardButton('Удалить несколько пользователей',        callback_data=ModifyRegistered.RemoveUser.str())],
